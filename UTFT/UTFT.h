...
class UTFT
{
	public:
		...
		void drawRect(int x1, int y1, int x2, int y2, byte raised=0, 
				byte RcolorTop=0, byte GcolorTop=0, byte BcolorTop=0, 
				byte RcolorBottom=0, byte GcolorBottom=0, byte BcolorBottom=0,
				int thickness=1);
		void drawRoundRect(int x1, int y1, int x2, int y2, 
					byte raised=0, byte RcolorTop=0, byte GcolorTop=0, byte BcolorTop=0, 
					byte RcolorBottom=0, byte GcolorBottom=0, byte BcolorBottom=0,
					int thickness=1);
		...
		void print(char *st, int x, int y, int deg=0, byte  isTransparent=0);
		void print(String st, int x, int y, int deg=0, byte  isTransparent=0);
		void printNumI(long num, int x, int y, int length=0, char filler=' ', byte  isTransparent=0);
		void printNumF(double num, byte dec, int x, int y, char divider='.', int length=0, char filler=' ', byte  isTransparent=0);
		...
		*/
		void drawButton(int x1, int y1, int x2, int y2, char *st, bitmapdatatype data, byte isRounded, byte isPressed1);
	...
	protected:
		...
		void printChar(byte c, int x, int y, byte  isTransparent=0);
		void setXY(word x1, word y1, word x2, word y2);
		void clrXY();
		void rotateChar(byte c, int x, int y, int pos, int deg, byte  isTransparent=0);
