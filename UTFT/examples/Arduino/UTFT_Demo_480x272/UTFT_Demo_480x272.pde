...
// Uncomment the next line for Arduino Mega and Due
UTFT myGLCD(ITDB43,38,39,40,41);   // Remember to change the model parameter to suit your display module!  byte model, int RS, int WR,int CS, int RST, int SER
